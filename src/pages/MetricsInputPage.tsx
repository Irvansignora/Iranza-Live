...
export default function MetricsInputPage() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true)
    const toNum = (v: string | undefined) => v ? parseFloat(v) || null : null
    const toInt = (v: string | undefined) => v ? parseInt(v) || null : null
    ...
    const payload = {
      ...
      total_revenue:        toInt(form.total_revenue) ??
        ((toInt(form.gift_revenue) || 0) + (toInt(form.product_revenue) || 0)) || null,
    }
